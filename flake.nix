  ...
  in {
    ...
    in
      ...
      // {
        ...
        isolation-library-green = fixtureGuard "green" "fixture-lib" "5 4 1 0 9 7" {
          path = ./tests/fixtures/isolation/fixture-lib/package.nix;
          kind = "library";
          set = "python3Packages";
        };
        isolation-asset-green = fixtureGuard "green" "fixture-asset" "5 4 0 1 9 7" {
          path = ./tests/fixtures/isolation/fixture-asset/package.nix;
          kind = "asset";
        };
        isolation-red-asset-bin = fixtureGuard "red" "asset-with-bin" "5 4 0 1 9 7" {
          path = ./tests/fixtures/isolation/asset-with-bin/package.nix;
          kind = "asset";
        };
        isolation-python-green = fixtureGuard "green" "python-cli" "5 5 0 0 9 8" {
          path = ./tests/fixtures/isolation/python-cli/package.nix;
          kind = "cli";
        };
        isolation-red-python-leak = fixtureGuard "red" "python-leak" "5 5 0 0 9 8" {
          path = ./tests/fixtures/isolation/python-leak/package.nix;
          kind = "cli";
        };
        isolation-red-leak = fixtureGuard "red" "leaking-bin" "5 5 0 0 9 8" {
          path = ./tests/fixtures/isolation/leaking-bin/package.nix;
          kind = "cli";
        };
        isolation-red-unkinded = fixtureGuard "red" "unkinded" "5 5 0 0 9 8" {
          path = ./tests/fixtures/isolation/unkinded/package.nix;
          kind = "cli";
        };
        isolation-red-missing-subject = fixtureGuard "red" "missing-subject" "5 5 0 0 9 8" {
          path = ./tests/fixtures/isolation/missing-subject/package.nix;
          kind = "cli";
        };
        isolation-red-misdeclared-runtime = fixtureGuard "red" "misdeclared-runtime" "5 5 0 0 9 8" {
          path = ./tests/fixtures/isolation/misdeclared-runtime/package.nix;
          kind = "cli";
        };
        isolation-red-unknown-family = fixtureGuard "red" "unknown-family" "5 5 0 0 9 8" {
          path = ./tests/fixtures/isolation/unknown-family/package.nix;
          kind = "cli";
        };
        isolation-red-wrong-set = fixtureGuard "red" "wrong-set" "5 4 1 0 9 7" {
